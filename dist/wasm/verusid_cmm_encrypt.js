/* @ts-self-types="./verusid_cmm_encrypt.d.ts" */
 ...
 * @param {EncryptPublicDecryptRequest} request
 * @returns {EncryptPublicDecryptResult}
 */
function encryptPublicDecrypt(request) {
    const ret = wasm.encryptPublicDecrypt(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
}
exports.encryptPublicDecrypt = encryptPublicDecrypt;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./verusid_cmm_encrypt_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/verusid_cmm_encrypt_bg.wasm`;
